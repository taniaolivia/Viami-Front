...
const entitlementID = 'Premium 1 semaine';

//TO DO: add your subscription terms and conditions
const footerText =
    "Un achat sera appliqué à votre compte dès confirmation du montant sélectionné. Veuillez noter que dans notre application, le produit acheté est un produit consommable et n'est pas un abonnement. Il est valable pour une durée d'une semaine et ne sera pas renouvelé automatiquement. Vous devrez donc racheter le produit à la fin de la période d'une semaine.";

//TO DO: add the Apple API key for your app from the RevenueCat dashboard: https://app.revenuecat.com
String appleApiKey = "${dotenv.env['APPLE_API_KEY']}";
