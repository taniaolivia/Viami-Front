...
class _ShowProfilePageState extends State<ShowProfilePage> {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Votre commentaire a été envoyé avec succès.'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
  ...
  Future<void> _showCommentBlankDialog() async {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Veuillez ajouter un commentaire !'),
          actions: <Widget>[
            TextButton(
              onPressed: () {
                Navigator.of(context).pop();
