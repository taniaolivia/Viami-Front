                            ...
                            children: [
                                    ...
                                    children: List.generate(
                                      ...
                                      (index) {
                                        return GestureDetector(
                                            onTap: () async {
                                              postsCity = await getAllPostsCity(
                                                  cities.forumCities[index].id);
                                                                ...
                                                                ? ListView
                                                                    .builder(
                                                                        ...
                                                                        itemBuilder:
                                                                            (context,
                                                                                postIndex) {
                                                                          getDateTime(postsCity!
                                                                              .forumPostsCities[postIndex]
                                                                              .postedOn);
                                                          ...
                                                          ElevatedButton(
                                                              onPressed:
                                                                ...
                                                                if (_formKey
                                                                    .currentState!
                                                                    .validate()) {
                                                                  await ForumPostsCitiesService().addPostToForumCity(
                                                                      token
                                                                          .toString(),
                                                                      postCityController
                                                                          .text,
                              ...
                              Align(
                                  ...
                                  child: IconButton(
                                      onPressed: () {
                                        ...
                                        if (switchTo == "newest") {
                                          posts =
                                              getAllOldestForumPosts() as Forum;
                                        } else {
                                          posts =
                                              getAllNewestForumPosts() as Forum;
                                        }
                                      },
                              ...
                              posts!.forum.isNotEmpty
                                  ? SizedBox(
                                      ...
                                      child: Column(
                                          children: List.generate(
                                              posts!.forum.length, (index) {
                                        getDateTime(
                                            posts!.forum[index].postedOn);
                                        return Align(
                                            alignment:
                                                userId == posts!.forum[index].user['id']
                                                    ? Alignment.topRight
                                                    : Alignment.topLeft,
                                            child: UnconstrainedBox(
                                                child: Container(
                                                          ...
                                                          children: [
                                                            Row(children: [
                                                              ...
                                                              CircleAvatar(
                                                                backgroundImage:
                                                                    NetworkImage(
                                                                        '${posts!.forum[index].user['profileImage']}'),
                                                                minRadius: 15,
                                                                maxRadius: 20,
                                                              ),
                                                              const SizedBox(
                                                          ...
                                                          child: Align(
                                                              ...
                                                              child: IconButton(
                                                                  onPressed:
                                                                      () async {
                                                                    postComments =
                                                                        await getAllCommentsPost(posts!
                                                                            .forum[index]
                                                                            .id);
                                                                    ...
                                                                    showModalBottomSheet<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Container(
                                                                            decoration:
                                                                                const BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(30.0), topRight: Radius.circular(30.0)), color: Colors.white),
