...
class _MessengerPageState extends State<MessengerPage> {
  ...
  Future<void> fetchData() async {
    ...
    if (plan != null) {
      ...
      if (tokenExpired) {
        await UserService()
            .updateUserPlanById(userId.toString(), "free", token.toString());
        setState(() {
          premium = false;
        });
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: (userMessagesCount == 5 && !premium) || showPremium
          ? BackdropFilter(
                                                                ...
                                                                onSelected:
                                                                  ...
                                                                  showDialog(
                                                                    ...
                                                                    builder:
                                                                        (BuildContext
                                                                            context) {
                                                                      var groupeIdPass = discussionMessages!
                                                                          .groups[
                                                                              index]
                                                                          .lastMessage
                                                                          .groupId;
                                                                  ...
                                                                  if (message
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                          FutureBuilder(
                                                                        future:
                                                                            getUserImages(message.senderId),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          if (snapshot.connectionState ==
                                                                            ...
                                                                            return Text('${snapshot.error}');
                                                                              ...
                                                                              snapshot.data!.userImages.isEmpty) {
                                                                            return GestureDetector(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        if (message.senderId !=
                                                                            userId)
                                                                          AutoSizeText(
                                                                            toBeginningOfSentenceCase(message.senderFirstName)!,
                                                                            minFontSize:
                                                                                10,
                                                                            maxFontSize:
                                                                                12,
                                                              ...
                                                              IconButton(
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  if (premium) {
                                                                    ...
                                                                    userMessagesCount = await MessagesService().getAllMessagesByUserId(
                                                                        token
                                                                            .toString(),
                                                                        userId
                                                                            .toString());
